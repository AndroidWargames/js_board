...
describe('rook', () => {
  it('is instantiable', () => {
    ...
    expect(new Rook(s, true)).toBeInstanceOf(Rook)
  })
  ...
  it('can call moveTo', () => {
    ...
    var r = new Rook(s, true)
    expect(r.hasMoved).toBeFalsy()
    r.moveTo(s2)
    expect(s.isEmpty()).toBeTruthy()
    expect(r.square).toEqual(s2)
    expect(r.hasMoved).toBeTruthy()
  })

  it('should be able to move vertically', () => {
    var board = newBoard()
    var b = new Rook(board.getSquare(2, 2), true)
  ...
  it('should be able to attack vertically', () => {
    var board = newBoard()
    var b = new Rook(board.getSquare(1, 1), true)
    var enemySquare = board.getSquare(4, 1)
    var enemy = new Rook(enemySquare, false)
  ...
  it('should not move in place', () => {
    ...
    var b = new Rook(startSquare, true)
  ...
  it('should not be able to attack same color pieces', () => {
    ...
    var ally = new Rook(whitePieceSquare, true)
    var whiteRook = new Rook(startSquare, true)
  ...
  it('should not be able to attack out of bounds', () => {
    ...
    var enemy = new Rook(outOfBounds, false)
    expect(whiteRook.canAttack(outOfBounds)).toBeFalsy()
  })
})
