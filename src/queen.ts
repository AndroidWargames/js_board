...
export default class Queen {
  ...
  canMoveTo(s: Square) {
    ...
    return this.canReachVertically(s, false) ||
      this.canReachHorizontally(s, false)
      this.canReachDiagonally(s, false);
  }
  ...
  canAttack(s: Square) {
    ...
    return this.canReachVertically(s, true) ||
      this.canReachHorizontally(s, true) ||
      this.canReachDiagonally(s, true);
  }
